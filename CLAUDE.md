...
Upload photos of handwritten coach reports, AI extracts student marks and attendance, admin reviews and saves them into a tabbed spreadsheet organized by school, semester, and class.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "207982576+DulYang@users.noreply.github.com"
  git config user.name "DulYang"
  ```
